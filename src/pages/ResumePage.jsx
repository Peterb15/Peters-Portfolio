  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-16 space-y-12">
      ...
      <header className="text-center space-y-2">
        ...
        <p className="text-lg text-gray-700">Creative Technologist & Storyteller</p>
      ...
      <section>
        ...
        <div className="space-y-8 text-gray-800">
          ...
          <div>
            <h3 className="text-lg font-medium">Learning Assistant – Text<br /><span className="text-sm text-gray-500">Jan 2025 – Present · ATLAS Institute, CU Boulder</span></h3>
            <ul className="list-disc list-inside mt-2">
          ...
          <div>
            <h3 className="text-lg font-medium">Zero Waste Event Lead<br /><span className="text-sm text-gray-500">Sept 2023 – Present · Environmental Center, CU Boulder</span></h3>
            <ul className="list-disc list-inside mt-2">
          ...
          <div>
            <h3 className="text-lg font-medium">Chief Creative Officer<br /><span className="text-sm text-gray-500">May 2023 – Present · Players Win Ties LLC</span></h3>
          ...
          <div>
            <h3 className="text-lg font-medium">Kitchen Manager<br /><span className="text-sm text-gray-500">Sept 2020 – Feb 2022 · Tip Top Savory Pies LLC</span></h3>
      ...
      <section>
        ...
        <div className="space-y-8 text-gray-800">
          <div>
            <h3 className="text-lg font-medium">The Shattered Lands<br /><span className="text-sm text-gray-500">Ongoing · Players Win Ties LLC</span></h3>
          ...
          <div>
            <h3 className="text-lg font-medium">The Laugh Bucket<br /><span className="text-sm text-gray-500">Nov 2024 · Whaaat!? Lab, ATLAS Institute</span></h3>
